...
if (isset($_POST['order'])) {
    ...
    if ($cart_total == 0) {
        ...
        mysqli_query($conn, "INSERT INTO `temp_orders`(user_id, name, number, email, method, address, total_products, total_price, placed_on) VALUES('$user_id', '$name', '$number', '$email', '$method', '$address', '$total_products', '$cart_total', '$placed_on')") or die('query failed');
...
<body>
        ...
        <form id="checkoutForm" action="" method="POST">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" name="street" placeholder="e.g.  Streetname">
                </div>
                <div class="inputBox">
                    <span>city :</span>
            ...
            <input type="submit" name="order" value="Proceed to Payments" class="btn">
    ...
    <script>
        document.getElementById('checkoutForm').addEventListener('submit', function(event) {
            ...
            var house = document.querySelector('[name="house"]').value;
            ...
            var pinCode = document.querySelector('[name="pin_code"]').value;

            if (!name || !number || !email || !house || !street || !city || !state || !country || !pinCode) {
